...
window.showArticleCard = function (realIndex) {
    ...
    const imgHtml = item.image
        ? `<img src="${item.image}" alt="${item.designation}" class="w-full h-48 object-contain rounded-xl border border-zinc-800 bg-zinc-950" onerror="this.parentElement.innerHTML='<div class=\\'w-full h-32 flex items-center justify-center text-zinc-700\\'>Pas d&apos;image</div>'">`
